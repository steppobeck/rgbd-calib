...
FIND_PATH(PCL_INCLUDE_DIR "pcl/pcl_base.h"
  ...
  /opt/csw # Blastwave
  /opt/pcl/install/include/pcl-1.8
  /opt/pcl/install/include/pcl-1.9
  /opt
  DOC "PCL - Headers"
)
...
SET(PCL_SEARCH_NAMES pcl_io_release pcl_search)
SET(PCL_SEARCH_DBG_NAMES pcl_search_debug)
...
FIND_LIBRARY(PCL_SEARCH_LIBRARY NAMES ${PCL_SEARCH_NAMES}
  PATHS
  $ENV{PCL_HOME}
  $ENV{EXTERNLIBS}/pcl
  ~/Library/Frameworks
...
#  )
  ...
  FIND_PACKAGE_HANDLE_STANDARD_ARGS(PCL DEFAULT_MSG PCL_LIBRARY PCL_LIBRARY_DEBUG PCL_IO_LIBRARY PCL_IO_LIBRARY_DEBUG PCL_INCLUDE_DIR)

  MARK_AS_ADVANCED(PCL_LIBRARY PCL_LIBRARY_DEBUG PCL_INCLUDE_DIR)
  
ELSE(MSVC)
  # rest of the world
  SET(PCL_LIBRARIES ${PCL_LIBRARY} ${PCL_IO_LIBRARY} ${PCL_SEARCH_LIBRARY})

  FIND_PACKAGE_HANDLE_STANDARD_ARGS(PCL DEFAULT_MSG PCL_LIBRARY PCL_IO_LIBRARY PCL_SEARCH_LIBRARY PCL_INCLUDE_DIR)
